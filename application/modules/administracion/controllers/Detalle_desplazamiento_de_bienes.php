...
class Ddb{   
    ...
    private $vista='v_detalle_desplazamiento_bien';
    ...
    public function get_result(){
     ...
     public function get_result_no_g($params=array()){
         $params_ = array(
                'tabla' =>$this->vista,
                'filtro'=>$params['filtro']
              );
        $getResult = new Crud($params_);     
...
class detalle_desplazamiento_de_bienes extends MX_Controller
{
