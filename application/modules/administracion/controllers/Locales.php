...
class Local{   
    ...
    public function get_registros2($param=array()){           
     ...
     public function set_registros_combo_con_filtro($id=""){  
            if($id==""){
                 $params = array(
                'tabla' => $this->tabla
...
class locales extends MX_Controller
{
...
public function eliminar($id="") {      
  ...
  public function set_registros_combo_con_filtro() {  
            ...
            $data_ = new Local("","");           
            $data=$data_->set_registros_combo_con_filtro($valor);
            $datos['xxx']=array();
            if($data){
                foreach ($data as $d) {   //ARMAMOS EL ARRAY PARA MOSTRAR EN LA GRILLA                                
                  $datos['xxx'][]=array(
