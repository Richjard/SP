<main role="main" class="container">
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light rounded">
      ...
      <div class="my-3 p-3 bg-white rounded shadow-sm">
        <h6 class="border-bottom border-gray pb-2 mb-0">SELECCIONE UNA CUENTA</h6>
        <?php       
       if($cuentas){
        ...
        <div class="media text-muted pt-3">
          ...
          -->
            <p class="media-body pb-3 mb-0 small lh-125 border-bottom border-gray">
              <a  class="btn btn-primary btn-lg btn-block" href="<?php echo base_url('cajero/cuenta/operaciones/'.$op."/".$cuenta->NRO_CUENTA); ?>"><?=$cuenta->DSC." ( ".$cuenta->NRO_CUENTA." )"?></a>
            </p>
        </div>
