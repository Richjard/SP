<main role="main" class="container">
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light rounded">
      ...
      <div class="my-3 p-3 bg-white rounded shadow-sm">
        <h6 class="border-bottom border-gray pb-2 mb-0"><?=$operacion." : ERROR"?> </h6>
        
         <form class="form-signin" action="<?= base_url('cajero/cuenta/transaccion/'.$op)?>" method="post">
       
    <h1 class="h1 mb-3 font-weight-normal"><i class="fas fa-money-check-alt"></i> No se puede retirar S/. <?=$monto?> </h1>
