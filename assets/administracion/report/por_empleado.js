    ...
    var data_combo_por_empleado_report = new ej.data.DataManager({//DATOS PARA OBTERNET DEL SERVIDOR PARA LA GRILLA
             url:base_url+"administracion/empleados/combo",//Establece el origen de datos para crear el Administrador de datos.
             adaptor: new ej.data.WebApiAdaptor
    });
    var combo_por_empleado_local_report = new ej.dropdowns.DropDownList({
        ...
        change: function () {
                ...
                combo_por_empleado_area_report.enabled = true;
                // frame the query based on selected value in country DropDownList.
                var tempQuery = new ej.data.Query().where('idlocales', 'equal', combo_por_empleado_local_report.value);
                // set the framed query based on selected value in country DropDownList.
                combo_por_empleado_area_report.query = tempQuery;
                // set null value to state DropDownList text property
                combo_por_empleado_area_report.text = null;
                // bind the property changes to state DropDownList
                combo_por_empleado_area_report.dataBind();
                // set null value to city DropDownList text property
                // set null value to city DropDownList text property
                combo_por_empleado_oficina_report.text = null;
                // disable the city DropDownList
                combo_por_empleado_oficina_report.enabled = false;
                // bind the property changes to City DropDownList
                combo_por_empleado_oficina_report.dataBind();
                
                combo_por_empleado_empleado_report.text = null;
                // disable the city DropDownList
                combo_por_empleado_empleado_report.enabled = false;
                // bind the property changes to City DropDownList
                combo_por_empleado_empleado_report.dataBind();
                 
            
        } ,
    });
    combo_por_empleado_local_report.appendTo('#combo_por_empleado_local_report');
    
    var combo_por_empleado_area_report = new ej.dropdowns.DropDownList({
        ...
        change: function () {
                ...
                combo_por_empleado_oficina_report.enabled = true;
                // Query the data source based on state DropDownList selected value
                var tempQuery1 = new ej.data.Query().where('idarea', 'equal', combo_por_empleado_area_report.value);
                // set the framed query based on selected value in city DropDownList.
                combo_por_empleado_oficina_report.query = tempQuery1;
    ...
    combo_por_empleado_area_report.appendTo('#combo_por_empleado_area_report');
    
    var combo_por_empleado_oficina_report = new ej.dropdowns.DropDownList({
        ...
        change: function () {
                // enable the city DropDownList
                combo_por_empleado_empleado_report.enabled = true;
                // Query the data source based on state DropDownList selected value
                var tempQuery1 = new ej.data.Query().where('idoficina', 'equal', combo_por_empleado_oficina_report.value);
                // set the framed query based on selected value in city DropDownList.
                combo_por_empleado_empleado_report.query = tempQuery1;
                //clear the existing selection
                combo_por_empleado_empleado_report.text = null;
                // bind the property change to city DropDownList
                combo_por_empleado_empleado_report.dataBind();
    ...
    combo_por_empleado_oficina_report.appendTo('#combo_por_empleado_oficina_report');
    var combo_por_empleado_empleado_report = new ej.dropdowns.DropDownList({
        dataSource: data_combo_por_empleado_report,
        popupHeight: '400px',
        popupWidth: '300px',
    ...
    combo_por_empleado_empleado_report.appendTo('#combo_por_empleado_empleado_report');